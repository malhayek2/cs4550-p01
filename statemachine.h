...
enum MachineState {
	...
	/*Other Operators:*/
	INSERTION_STATE, ASSIGNMENT_STATE, PLUS_STATE, MINUS_STATE, TIMES_STATE, DIVIDE_STATE, PLUSEQUAL_STATE, MINUSEQUAL_STATE,TIMESEQUAL_STATE,DIVIDEEQUAL_STATE, MOD_STATE,
	/*Other Characters:*/
...
enum CharacterType {
	...
	/*Other Operators:*/
	INSERTION_CHAR, ASSIGNMENT_CHAR, PLUS_CHAR, MINUS_CHAR, TIMES_CHAR, DIVIDE_CHAR, MOD_CHAR,
	/*Other Characters:*/
