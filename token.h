...
enum TokenType 
{
	...
	/*Other Operators:*/
	INSERTION_TOKEN, ASSIGNMENT_TOKEN, PLUS_TOKEN, MINUS_TOKEN, TIMES_TOKEN, DIVIDE_TOKEN, PLUSEQUAL_TOKEN, MINUSEQUAL_TOKEN, TIMESEQUAL_TOKEN, DIVIDEEQUAL_TOKEN, MOD_TOKEN,
	/*Other Characters:*/
	SEMICOLON_TOKEN, LPAREN_TOKEN, RPAREN_TOKEN, LCURLY_TOKEN, RCURLY_TOKEN, OR_TOKEN, AND_TOKEN,
	/*Other Token Types:*/
	BEGIN_TOKEN,END_TOKEN,IDENTIFIER_TOKEN, INTEGER_TOKEN, BAD_TOKEN, ENDFILE_TOKEN, ENDL_TOKEN, DO_TOKEN
};
